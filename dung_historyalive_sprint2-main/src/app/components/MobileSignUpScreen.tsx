      ...
      <div className="flex-1 overflow-y-auto px-6 pb-8">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-[56px] bg-[#FCCF03] rounded-[16px] font-bold text-[#0f172a] text-[16px] hover:bg-[#ffd633] transition-all shadow-md active:scale-[0.98] mt-6 flex items-center justify-center border-2 border-[#e5b800]"
          >
          ...
          {/* Social Sign Up Buttons - Minimalist Group */}
