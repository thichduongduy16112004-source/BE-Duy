import svgPaths from "./svg-uifmgf0b66";
...
function Overlay() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.2)] content-stretch flex inset-[4px_4px_3.99px_4px] items-center justify-center" data-name="Overlay">
      <Button />
    </div>
  );
}
...
function VideoControlsOverlay() {
  return (
    <div className="absolute bg-gradient-to-t bottom-[3.99px] content-stretch flex flex-col from-[rgba(0,0,0,0.6)] gap-[4px] items-start left-[4px] px-[16px] py-[12px] right-[4px] to-[rgba(0,0,0,0)]" data-name="Video Controls Overlay">
      <Container5 />
      <Overlay1 />
    </div>
  );
