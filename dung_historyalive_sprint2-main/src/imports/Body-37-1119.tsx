import svgPaths from "./svg-ybnifj7n3a";
    ...
    <div className="h-[85.5px] relative shrink-0 w-[96.25px]" data-name="Shadow">
      <div className="absolute inset-[0_-10.39%_-23.39%_-10.39%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 116.25 105.5">
          <g filter="url(#filter0_d_37_990)" id="Shadow">
            <path d={svgPaths.p34ba1000} fill="var(--fill-0, #FCCF03)" id="Icon" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="105.5" id="filter0_d_37_990" width="116.25" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_37_990" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_37_990" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function HeroSection() {
  return (
    <div className="absolute h-[273.5px] left-0 right-[-0.3px] top-[88px]" data-name="Hero Section">
      <Heading1Margin />
...
function PlansContainer() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-0 pb-[32px] px-[24px] right-[-0.3px] top-[361.5px]" data-name="Plans Container">
      <ProPlanPlan />
      <EduPlanPlan />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute backdrop-blur-[6px] bg-[rgba(245,245,220,0.8)] content-stretch flex items-center justify-between left-0 pl-[24px] pr-[64px] py-[24px] right-[-0.3px] top-0" data-name="Header">
      <Button2 />
      <Heading1 />
    </div>
  );
...
function Background() {
  return (
    <div className="bg-[#f5f5dc] h-full max-w-[430px] min-h-[916px] relative shrink-0 w-[380px]" data-name="Background">
      <HeroSection />
      <PlansContainer />
      <Header />
    </div>
